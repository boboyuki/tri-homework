...
export const Content = ({ className }: { className?: string }) => {
  ...
  return(
    <div className={`${className} flex flex-col md:flex-row items-middle justify-between bg-[#DCCCBC]`}>
            {
              intros.map((intro) => {
                return (
                  <div key={intro.id} className="flex-1 flex flex-row items-middle py-[60px] px-[50px]">
